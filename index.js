    ...
    async function updateOne(extension, $popup) {
        ...
        try {
            ...
            if (data?.isUpToDate) {
                ...
                const reloaded = await hotReload(extension);
